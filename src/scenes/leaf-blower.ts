...
export class LeafBlower {
    ...
    public blow(): void {
        ...
        const particleAngleMin = this.player.rotation - LeafBlower.BLOWER_OPENING_ANGLE;
        const particleAngleMax = this.player.rotation + LeafBlower.BLOWER_OPENING_ANGLE;
